...
M = 256.19  # Mass of air (kg)
c = 1.005  # Specific heat of air (kJ/kg·K)
k_fiber = 0.3  # Thermal conductivity
s_fiber = 0.4  # Thickness
A_fiber = 92  # Surface area (m**2)
k_glass = 1.8  # Thermal conductivity
s_glass = 0.028  # Thickness
...
plt.title('Indoor vs Outdoor Temperature Over Time (House 3)')
plt.grid(True)
plt.legend()
plt.show()